...
for i, n_h in enumerate(hidden_layer_sizes):
    ...
    try:
        ...
        # Train Metrics
        y_pred_train_inv = scaler_y.inverse_transform(Y_prediction_train.flatten().reshape(-1, 1)).flatten()
        ...
        if r2_train > 0.9 and r2_test < 0.7:
            print("⚠️  OVERFITTING: High Train R², Low Test R²")
        elif r2_train < 0.5 and r2_test < 0.5:
            print("⚠️  UNDERFITTING: Poor performance on Train and Test")
        elif abs(r2_train - r2_test) < 0.1:
            print("✅ GOOD FIT: Similar performance on Train/Test")
        else:
            print("⚠️  POSSIBLE OVERFITTING: Notable gap between Train and Test")
        print()
